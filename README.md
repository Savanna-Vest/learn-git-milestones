...
- [x] Open the repo in Visual Studio Code: Repository > Open in Visual Studio Code  
- [x] ✏️ In Visual Studio Code, edit this README file and add your *second* favorite emoji here: 👀
